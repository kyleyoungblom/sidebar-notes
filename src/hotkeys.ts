...
export const DEFAULT_HOTKEYS: Record<string, HotkeyDef> = {
  ...
  'cycle-note-up':     { key: 'ArrowLeft',  scope: 'editor',  label: 'Previous note',      group: 'Editor', alt: true },
  'cycle-note-down':   { key: 'ArrowRight', scope: 'editor',  label: 'Next note',          group: 'Editor', alt: true },
